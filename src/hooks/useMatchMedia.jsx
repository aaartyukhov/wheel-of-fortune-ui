...
/**
 * Возвращает флаг, использующийся для определения соответствия документа переданной строке медиавыражения
 *
 * @param {string} query строка медиавыражения
 * @returns {boolean} true если в document настоящее время соответствует списку медиа-запросов или false нет
 */
